...
use simdutf8_portable::basic::from_utf8 as basic_from_utf8;
use simdutf8_portable::basic::from_utf8_mut as basic_from_utf8_mut;
use simdutf8_portable::compat::from_utf8 as compat_from_utf8;
use simdutf8_portable::compat::from_utf8_mut as compat_from_utf8_mut;
...
fn test_invalid(input: &[u8], valid_up_to: usize, error_len: Option<usize>) {
    ...
    #[cfg(feature = "public_imp")]
    public_imp::test_invalid(input, valid_up_to, error_len);
}
